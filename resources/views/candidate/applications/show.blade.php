    ...
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body px-5 pt-3 pb-5">
            ...
            <div class="step active" id="step1">
                ...
                <div class="row mb-3">
                    <div class="col-md-4 mb-3">
                        <strong>Father Name in Nepali (बुबाको नाम नेपालीमा):</strong>
                        <p class="mb-0">{{ $applicationform->father_name_nepali ?? '-' }}</p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <strong>Mother Name in Nepali (आमाको नाम नेपालीमा):</strong>
                        <p class="mb-0">{{ $applicationform->mother_name_nepali ?? '-' }}</p>
                    </div>
                    <div class="col-md-4 mb-3">
                        <strong>Grandfather Name in Nepali (हजुरबुबाको नाम नेपालीमा):</strong>
                        <p class="mb-0">{{ $applicationform->grandfather_name_nepali ?? '-' }}</p>
                    </div>
                </div>
