...
setTimeout(() => {
    ...
    return '-';
        ...
        set('p_noc_id_card', val('noc_id_card'));

        // General Information
        let religion = val('religion');
        if(religion === 'Other')
        {
            religion += ' (' + val('religion_other') + ')';
        }
        document.getElementById('p_religion').innerText = religion;

        let community = val('community');
        if(community === 'Other')
        {
            community += ' (' + val('community_other') + ')';
        }
        document.getElementById('p_community').innerText = community;

        let ethnic = val('ethnic_group');
        if(ethnic === 'Other')
        {
            ethnic += ' (' + val('ethnic_group_other') + ')';
        }
        document.getElementById('p_ethnic_group').innerText = ethnic;


        document.getElementById('p_mother_tongue').innerText =
            val('mother_tongue');


        document.getElementById('p_employment_status').innerText =
            val('employment_status');


        document.getElementById('p_physical_disability').innerText =
            val('physical_disability');


        document.getElementById('p_ethnic_certificate').innerText =
            fileName('ethnic_certificate');

        document.getElementById('p_disability_certificate').innerText =
