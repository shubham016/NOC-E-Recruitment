                ...
                <div class="details-left">
                    <table class="info-table">
                        <tr>
                            ...
                            <td class="value">: {{ $toNp($application->roll_number ?? $application->id) }}</td>
                        </tr>
                        <tr>
                    ...
                    <table class="info-table mt-2">
                        <tr>
                            ...
                            <td class="value">: {{ $toNp($application->advertisement_no ?? '') }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="value">: {{ $toNp($application->citizenship_number ?? '') }}</td>
                        </tr>
                    </table>
