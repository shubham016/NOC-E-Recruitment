            ...
            <div class="noc-right">
                <div class="noc-form-body">
                    ...
                    <form method="POST" action="{{ route('candidate.register.post') }}" novalidate>
                        ...
                        <div class="noc-field">
                            <label for="middle_name">Middle Name <span style="color: #888;">(Optional)</span></label>
                            <div class="noc-input-group">
                                <input
                                    type="text"
                                    id="middle_name"
                            ...
                            <div class="noc-field">
                                ...
                                <div class="noc-input-group">
                                    <input
                                        ...
                                        required
                                    >
                                    <span class="noc-input-icon"><i class="bi bi-at"></i></span>
                                    @error('username')
                                        <div class="noc-invalid-feedback"><i class="bi bi-x-circle"></i> {{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="noc-field">
                            ...
                            <div class="noc-input-group">
                                <input
                                    ...
                                    class="{{ $errors->has('mobile_number') ? 'is-invalid' : '' }}"
                                    pattern="[0-9]{10}"
                                    maxlength="10"
                                    required
                                >
                            ...
                            <div class="noc-field">
                                ...
                                <div class="noc-input-group">
                                    <input
                                        ...
                                        class="{{ $errors->has('citizenship_issue_district') ? 'is-invalid' : '' }}"
                                        required
                                    >
