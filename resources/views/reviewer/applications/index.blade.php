...
.bulk-action-btn:hover {
    ...
    box-shadow: 0 4px 12px rgba(22, 49, 92, 0.25);
}
...
.bulk-action-btn:focus {
    box-shadow: 0 0 0 0.2rem rgba(22, 49, 92, 0.25);
}
...
/* "Danger" → light grey-blue */
.custom-status-btn.is-danger {
    background-color: #d3dde8;
    color: #16315c; /* dark text for readability */
}

/* "Warning" → primary dark blue */
.custom-status-btn.is-warning {
    background-color: #16315c;
    color: #fff;
}

/* Hover effects */
.custom-status-btn.is-danger:hover {
    background-color: #c2d0df;
}

.custom-status-btn.is-warning:hover {
    background-color: #20457f;
}
</style>
@endpush
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        <button type="submit" class="btn w-100"
                            style="background-color: #16315c; border-color: #16315c; color: #fff;">
                            {{ __('reviewer.search') }}
                        </button>
                    </div>
                </div>
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-2">
            <span class="fw-bold text-dark">
                <span id="selectedCount">0</span> {{ __('reviewer.applications_selected') }}
            </span>

            <button type="button" id="clearSelectionBtn" class="bulk-action-btn">
                {{ __('reviewer.clear_selection') }}
            </button>
        </div>

        <div class="d-flex gap-2">
            <button type="button" id="exportCsvBtn" class="bulk-action-btn">
                {{ __('reviewer.export_to_excel') }}
            </button>

            <button type="button" id="exportPdfBtn" class="bulk-action-btn">
                        ...
                        <tr class="application-card">
                            ...
                            <td class="nowrap">
                                <a href="{{ route('reviewer.applications.show', $application->id) }}"
                                   class="btn btn-sm custom-status-btn {{ in_array($application->status, ['approved', 'rejected', 'reviewed']) ? 'is-danger' : 'is-warning' }}">
