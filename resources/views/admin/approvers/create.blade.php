...
@section('title', __('admin.create_new_approver'))
    ...
    <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, #1d6df7 0%, #1557c0 100%);">
        <div class="card-body text-white p-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-2 fw-bold"><i class="bi bi-person-plus me-2"></i>{{ __('admin.create_new_approver') }}</h2>
                    <p class="mb-0 opacity-90">{{ __('admin.add_approver_to_system') }}</p>
                </div>
            ...
            <form action="{{ route('admin.approvers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-4 d-flex gap-2">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="bi bi-save me-2"></i>{{ __('admin.create_new_approver') }}
                    </button>
