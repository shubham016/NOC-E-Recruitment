                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="phone"
                                        ...
                                        value="{{ old('phone', $reviewer->phone) }}" placeholder="+977-9841234567">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        value="{{ old('email', $reviewer->email) }}" placeholder="reviewer@noc.gov.np"
                                        required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-section">
                        ...
                        <div class="photo-upload-container" id="photoUploadContainer">
                            ...
                            <!-- Preview Wrapper -->
                            <div class="photo-preview-wrapper {{ $reviewer->photo ? 'active' : '' }}"
                                id="photoPreviewWrapper">
                                <img id="photoPreview" class="photo-preview"
                                    src="{{ $reviewer->photo ? asset('storage/' . $reviewer->photo) : '' }}" alt="Preview">
                            </div>

                            <!-- Upload Icon & Text -->
                            <div id="uploadPrompt" style="{{ $reviewer->photo ? 'display: none;' : '' }}">
                    ...
                    <div class="info-box">
                        ...
                        <ul class="info-list">
                            <li>
                                <i class="bi bi-person-badge"></i>
                                <span><strong>ID:</strong> {{ $reviewer->id }}</span>
                            </li>
                            <li>
