                ...
                <table class="table align-middle mb-0 modern-table w-100"
                    ...
                    <tbody class="text-center align-middle" style="border: none;">
                        @php
                            ...
                            $i = 0;
                            while ($i < $total) {
                                $key   = ($jobItems[$i]->position ?? '') . '___' . ($jobItems[$i]->level ?? '') . '___' . ($jobItems[$i]->service_group ?? '');
                                $count = 1;
                                while ($i + $count < $total) {
                                    $nk = ($jobItems[$i + $count]->position ?? '') . '___' . ($jobItems[$i + $count]->level ?? '') . '___' . ($jobItems[$i + $count]->service_group ?? '');
