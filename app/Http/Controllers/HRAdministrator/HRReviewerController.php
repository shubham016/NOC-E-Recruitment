...
class HRReviewerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Reviewer::withCount(['applicationForms as total_reviewed' => function ($q) {
    ...
    public function show($id)
    {
        ...
        $reviewer = Reviewer::withCount([
            'applicationForms as total_assigned',
    ...
    public function destroy($id)
    {
        ...
        if ($reviewer->applicationForms()->where('status', 'approved')->count() > 0) {
            return redirect()
                ->back()
