                        ...
                        @else
                            ...
                            <div class="d-flex flex-wrap gap-3" id="categoryCheckboxGroup">
                                ...
                                @php
                                    ...
                                    // Use category as single source of truth
                                    $gInclusiveTypes = [];
                                    if ($gJob->category === 'inclusive' && $gJob->inclusive_type) {
                                        $gDecoded = json_decode($gJob->inclusive_type, true);
                                        $gInclusiveTypes = is_array($gDecoded) ? $gDecoded : [];
                                    }
                                    $gInternalInclusiveTypes = [];
                                    if ($gJob->category === 'internal' && is_array($gJob->internal_inclusive_types)) {
                                ...
                                @if($gJob->category === 'inclusive' && count($gInclusiveTypes) > 0)
                                    ...
                                    @endforeach
                                @elseif($gJob->category === 'inclusive')
                                    {{-- Inclusive with no specific types --}}
                                    <div class="border rounded p-3 category-option" style="min-width:180px;" data-adv-no="{{ $gAdvNo }}">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input category-cb" type="checkbox"
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="exp1_start_date_bs" class="form-control nepali-date" placeholder="YYYY-MM-DD"
                                    value="{{ old('exp1_start_date_bs', $draftApplication->exp1_start_date ?? '') }}"></td>
                                <td><input type="text" name="exp1_end_date_bs" class="form-control nepali-date" placeholder="YYYY-MM-DD"
                                    value="{{ old('exp1_end_date_bs', $draftApplication->exp1_end_date ?? '') }}"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="exp2_start_date_bs" class="form-control nepali-date" placeholder="YYYY-MM-DD"
                                    value="{{ old('exp2_start_date_bs', $draftApplication->exp2_start_date ?? '') }}"></td>
                                <td><input type="text" name="exp2_end_date_bs" class="form-control nepali-date" placeholder="YYYY-MM-DD"
                                    value="{{ old('exp2_end_date_bs', $draftApplication->exp2_end_date ?? '') }}"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="exp3_start_date_bs" class="form-control nepali-date" placeholder="YYYY-MM-DD"
                                    value="{{ old('exp3_start_date_bs', $draftApplication->exp3_start_date ?? '') }}"></td>
                                <td><input type="text" name="exp3_end_date_bs" class="form-control nepali-date" placeholder="YYYY-MM-DD"
                                    value="{{ old('exp3_end_date_bs', $draftApplication->exp3_end_date ?? '') }}"></td>
