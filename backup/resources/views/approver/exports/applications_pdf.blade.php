...
<div class="page">
    ...
    <div class="meta-row">
        <div>
            ...
            <span>Exported By: <strong>{{ Auth::guard('approver')->user()->employee_id ?? 'Approver' }}</strong></span>
        </div>
        <div style="text-align:right;">
            <span>Total Records: <strong>{{ $applications->count() }}</strong></span>
            <span>Report Type: <strong>Online Generated</strong></span>
        </div>
    </div>
    ...
    <table class="main-table">
        <thead>
            <tr>
                ...
                <th style="width:90px;">Advertisement No</th>
                <th style="width:30px;">App ID</th>
                <th style="width:90px;">Full Name</th>
                <th style="width:90px;">Vacancy Type</th>
                <th style="width:65px;">Payment</th>
                <th style="width:65px;">Applied Date</th>
        ...
        <tbody>
            @foreach($applications as $index => $application)
                ...
                <tr>
                    ...
                    <td>
                        <span class="name">{{ $application->name_english ?? 'N/A' }}</span>
                        <span class="name">{{ $application->name_nepali  ?? 'N/A' }}</span>
                    </td>

                    <td>
                        <span class="pos">{{ $application->jobPosting->title ?? 'N/A' }}</span>
                        <span class="dept">{{ $application->jobPosting->category ?? 'N/A' }}</span>
                    </td>
